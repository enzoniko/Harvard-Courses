...
function SnailChasingState:update(dt)
    ...
    elseif self.player.y + self.player.height < self.snail.y then
        if self.player.x < self.snail.x then
            self.snail.direction = 'right'
            self.snail.x = self.snail.x + (SNAIL_MOVE_SPEED + 40) * dt
    ...
    elseif self.player.x < self.snail.x then
        self.snail.direction = 'left'
        self.snail.x = self.snail.x - (SNAIL_MOVE_SPEED + 80) * dt 
