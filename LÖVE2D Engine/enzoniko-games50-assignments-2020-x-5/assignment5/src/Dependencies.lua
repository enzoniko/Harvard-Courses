...
gSounds = {
    ...
    ['heart'] = love.audio.newSource('sounds/cuoredown2.wav', 'static'),
    ['broke'] = love.audio.newSource('sounds/brokentwo.wav', 'static')
}

gSounds['music']:setVolume(0.1)
gSounds['sword']:setVolume(0.2)
gSounds['hit-enemy']:setVolume(0.2)
gSounds['hit-player']:setVolume(0.2)
gSounds['door']:setVolume(0.2)
gSounds['heart']:setVolume(1)
gSounds['broke']:setVolume(1)
