...
function StartState:init()
    ...
    for i = 1, 300 do
        table.insert(self.aliens, Alien(self.world, 'square', math.random(100, 300), -500))
    end   
end
...
function StartState:update(dt)
    ...
    if x > 0 then
        ...
        table.insert(self.aliens, Alien(self.world, 'round', math.random(100, 300), -1000, 'Player'))
        x = 300
    end
    ...
    if y > 0 then
        ...
        table.insert(self.aliens, Alien(self.world, 'square', math.random(100, 300), -1000))
        y = 10
    end
