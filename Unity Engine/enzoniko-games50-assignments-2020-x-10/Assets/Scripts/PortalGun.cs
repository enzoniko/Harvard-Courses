...
public class PortalGun : MonoBehaviour {
	...
	public static bool blueUsed = false;
	public static bool orangeUsed = false;
	...
	void FirePortal(string type) {
		...
		if (Physics.Raycast(gunTip.transform.position, transform.TransformDirection(Vector3.forward), out hit, 10f)) {
			portalSound.Play();
